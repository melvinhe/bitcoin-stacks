...
(event (CollateralDeposited (user address) (token address) (amount uint)))
(event (CollateralRedeemed (redeemFrom address) (redeemTo address) (token address) (amount uint)))

(define-error DSCEngine__TokenAddressesAndPriceFeedAddressesAmountsDontMatch)
(define-error DSCEngine__NeedsMoreThanZero)
(define-error DSCEngine__TokenNotAllowed)
(define-error DSCEngine__TransferFailed)
(define-error DSCEngine__BreaksHealthFactor)
(define-error DSCEngine__MintFailed)
(define-error DSCEngine__HealthFactorOk)
(define-error DSCEngine__HealthFactorNotImproved)
